...
class SessionsSessionBaseFilter(BaseModel):
    ...
    with_data_types: Optional[list[DataTypeEnum]] = Field(
        alias="withDataTypes", default=None
    )
...
class UpdateCameraOwnershipAttributes(BaseModel):
    """Attributes for updating a camera ownership"""

    name: str
    "The new name for the camera ownership"
