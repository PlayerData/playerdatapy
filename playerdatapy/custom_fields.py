...
class AthleteRecordsFields(GraphQLField):
    ...
    def fields(
        self, *subfields: Union[AthleteRecordsGraphQLField, "PersonalBestsFields"]
    ) -> "AthleteRecordsFields":
...
class ClubFields(GraphQLField):
    ...
    @classmethod
    def surveys(cls, *, archived: Optional[bool] = None) -> "SurveyFields":
        arguments: dict[str, dict[str, Any]] = {
...
class MatchSessionFields(GraphQLField):
    ...
    @classmethod
    def ball_data_recordings(cls) -> "BallDataRecordingFields":
        return BallDataRecordingFields("ballDataRecordings")
...
class VideoRecordingFields(GraphQLField):
    ...
    def fields(self, *subfields: VideoRecordingGraphQLField) -> "VideoRecordingFields":
